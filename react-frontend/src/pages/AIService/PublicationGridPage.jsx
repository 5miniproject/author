                                ...
                                >
                                    ...
                                    <td style={{ padding: '12px' }}>
                                        {publication.coverImageUrl ? (
                                            <img src={publication.coverImageUrl} alt="Cover" style={{ width: '50px', height: 'auto', borderRadius: '4px' }} />
                                        ) : 'No Image'}
                                    </td>
                                    <td style={{ padding: '12px' }}>
                                        {publication.plotUrl ? (
                                            <a href={publication.plotUrl} target="_blank" rel="noopener noreferrer">Download PDF</a>
                                        ) : 'No Plot'}
                                    </td>
                                </tr>
                            ))
                ...
                <div style={{ marginTop: '20px', padding: '20px', border: '1px solid #ccc', borderRadius: '8px', backgroundColor: '#f9f9f9' }}>
                    ...
                    {selectedRow.coverImageUrl && (
                        <div style={{ marginTop: '20px', textAlign: 'center' }}>
                            <h4>생성된 표지 이미지</h4>
                            <img src={selectedRow.coverImageUrl} alt="Generated Cover" style={{ maxWidth: '300px', maxHeight: '300px', border: '1px solid #ddd', borderRadius: '8px' }} />
                        </div>
                    )}
